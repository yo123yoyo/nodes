...
sed -i "s|8001:8001|18001:8001|" /home/config/docker/docker-compose/go/allora-worker-x-reputer/allora-node/docker-compose.yaml
sed -i "s|8002:8002|18002:8002|" /home/config/docker/docker-compose/go/allora-worker-x-reputer/allora-node/docker-compose.yaml
sed -i "s|8003:8003|18003:8003|" /home/config/docker/docker-compose/go/allora-worker-x-reputer/allora-node/docker-compose.yaml
